...
if __name__ == "__main__":
    if len(sys.argv) != 2:
        print("Usage: python check_jtbd_coverage.py <document.md>")
        print("\nThis script checks for:")
        print("  - References to all 4 core JTBD jobs")
        print("  - Superpower mentions")
        print("  - Architectural view coverage")
        sys.exit(1)
